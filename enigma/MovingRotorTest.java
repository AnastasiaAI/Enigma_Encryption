...
public class MovingRotorTest {
    ...
    /** Checking if the rotor advances properly. */
    @Test
    public void checkAdvance() {
        setRotor("II", NAVALA, "E");
        checkRotor("Rotor II (F)", UPPER_STRING, NAVALA_MAP.get("II"));

        setRotor("III", NAVALA, "V");
        checkRotor("Rotor III (A)", UPPER_STRING, NAVALA_MAP.get("III"));

        setRotor("IV", NAVALA, "J");
        checkRotor("Rotor IV (A)", UPPER_STRING, NAVALA_MAP.get("IV"));

        setRotor("V", NAVALA, "Z");
        checkRotor("Rotor VI (A)", UPPER_STRING, NAVALA_MAP.get("V"));

        setRotor("VI", NAVALA, "ZM");
        checkRotor("Rotor VI (A)", UPPER_STRING, NAVALA_MAP.get("VI"));

        setRotor("VII", NAVALA, "ZM");
        checkRotor("Rotor VII (A)", UPPER_STRING, NAVALA_MAP.get("VII"));

        setRotor("VIII", NAVALA, "ZM");
        checkRotor("Rotor VIII (A)", UPPER_STRING, NAVALA_MAP.get("VIII"));
    ...
    public void checkSet() {
        ...
        setRotor("VII", NAVALA, "E");
        rotor.set(51);
        checkRotor("Rotor VII set", UPPER_STRING, NAVALZ_MAP.get("VII"));
